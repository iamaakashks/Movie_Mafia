...
export default function Trending() {
  ...
  document.title = "Movie Mafia | Popular | " + category.toUpperCase();
  ...
  const filteredData = searchTerm ? popularData.filter((item) => (item.title || item.name || item.original_name || item.original_title).toLowerCase().includes(searchTerm.toLowerCase())) : popularData;
